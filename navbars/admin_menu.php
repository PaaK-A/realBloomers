			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li><a href="../admin/category_form.php">Category</a></li>
								<li><a href="../admin/brand_form.php">Brand</a>
								</li>
								<li><a href="../admin/products_form.php">Products</a>
								</li>
                                <li><a href="../admin/advice_form.php">Advice</a>
								</li>
								<li>
