...
<body>
			...
			<div class="row">
				<div class="col-lg-7">
					<div class="featured-text">
						<h2 class="pb-3">Why <span class="orange-text">Bloomers</span></h2>
						<div class="row">
							<div class="col-lg-6 col-md-6 mb-4 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Home Delivery</h3>
										<p>Shop our wide selection of high-quality plants and enjoy fast and convenient home delivery.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 mb-5 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Best Price</h3>
										<p>Shop with us and enjoy the best prices on high-quality plants."</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 mb-5 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Easy Payment</h3>
										<p>Experience easy and convenient payment options when you shop with us</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Quick Refund</h3>
										<p>Shop our wide selection of plants and enjoy fast and easy refunds</p>
									</div>
								</div>
							</div>
						</div>
	...
	<!-- shop banner -->
	<section class="shop-banner" hidden>
    	<div class="container">
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">
						...
						<p>Meet the passionate and knowledgeable team that brings you the best selection of high-quality plants and exceptional customer service.</p>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-10 offset-lg-1 text-center">
					<div class="testimonial-sliders">
						...
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>David Niph <span>Home owner</span></h3>
								<p class="testimonial-body">
						...
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>Jacob Sikim <span>Librarian</span></h3>
								<p class="testimonial-body">
