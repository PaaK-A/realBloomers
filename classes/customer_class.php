...
class customer_class extends db_connection
{
	...
	//--INSERT customer--//
	public function addCustomer_cls($cusName,$cusEmail,$cusPass,$cusCountry,$cusCity,$cusContact){
		//write query
		$usrRole='2';
		$insertsql = "INSERT INTO customer(customer_name,customer_email,customer_pass,customer_country,customer_city,customer_contact,user_role) VALUES ('$cusName','$cusEmail','$cusPass','$cusCountry','$cusCity','$cusContact',$usrRole)";
   ...
   //--INSERT admin--//
	public function addAdmin_cls($cusName,$cusNum,$cusEmail,$cusPass,$cusCountry,$cusCity,$cusContact,$usrRole){
		//write query
		$usrRole='1';
		$insertsql = "INSERT INTO customer(customer_name,customer_email,customer_pass,customer_country,,customer_city,customer_contact,customer_image,user_role) VALUES ('$cusName','$cusNum','$cusEmail','$cusPass','$cusCountry','$cusCity','$cusContact',$usrRole)";
